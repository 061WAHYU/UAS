    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-slate-200">{{ __('Remember me') }}</span>
            </label>
        </div>
        ...
        <section class="min-h-screen flex items-stretch text-white">
            ...
            <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0"
                ...
                <div class="w-full py-6 z-20">
                    <h1 class="my-6 text-5xl font-extrabold text-orange-500">Lets<span class="text-cyan-500">Work</span>
                    </h1>
                    ...
                    <form action="{{ route('login') }}" method="POST" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                        ...
                        <div class="px-4 pb-2 pt-4">
                            <button
                                class="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">sign in</button>
                        </div>
