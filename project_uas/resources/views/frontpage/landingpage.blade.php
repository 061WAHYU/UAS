<x-home-layout>
    <div class="relative overflow-hidden bg-white h-screen p-0">
          ...
          >
            ...
            >
              <div class="sm:text-center lg:text-left pt-16">
                ...
                >
                  <p class="block xl:inline">LetsWork</p> <br>
                  <p class="block text-blue-600 xl:inline"
                ...
                >
                LetsWork adalah Situs lowongan kerja (Job Portal) layanan berbasis software fokus dibidang rekrutmen untuk mempermudah cari pekerjaan dan perekrutan karyawan.
                </p>
                <div
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w">
          <img
            class="h-90 w-1/2 object-cover sm:h-full md:h-full lg:h-full lg:w-full mr-6 md:visible invisible"
            src ="https://png.pngtree.com/thumb_back/fw800/background/20210903/pngtree-business-portrait-teamwork-win-win-conference-photography-map-with-map-image_801473.jpg"
            alt=""
          />
        </div>
      </div>
