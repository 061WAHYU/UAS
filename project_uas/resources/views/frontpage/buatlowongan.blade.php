                ...
                <div class="grid grid-cols-2">
                    ...
                    <div>
                      ...
                      <section class=" py-1 bg-white">
                          <div class="w-full lg:w-8/16 px-4 mx-auto mt-6">
                              <div
                                      ...
                                      <form>
                                          <div class="flex flex-wrap mt-6">
                                              ...
                                              <div class="w-full lg:w-6/12 px-4">
                                                <div class="relative w-full mb-3">
                                                    ...
                                                    <select id="Pilih Pendidikan"
                                                        class="text-base text-gray-800 outline-none border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                                        value="Lucky"">
                                                        <option value="Pilih Pendidikan" selected>Pilih Pendidikan</option>
                                                        <option value="net">net</option>
                                                        <option value="org">org</option>
                                                        <option value="io">io</option>
                                                    </select>
                                              ...
                                              <div class="w-full lg:w-6/12 px-4">
                                                  <div class="relative w-full mb-3">
                                                      ...
                                                      <select id="Pilih Tipe"
                                                          class="text-base text-gray-800 outline-none border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                                          value="Lucky"">
                                                          <option value="Pilih Tipe" selected>Pilih Tipe</option>
                                                          <option value="net">net</option>
                                                          <option value="org">org</option>
                                                          <option value="io">io</option>
                                                      </select>
                                          ...
                                          <div class="w-full lg:w-6/12 px-4">
                                            <div class="relative w-full mb-3">
                                                ...
                                                <select id="Pilih Gaji"
                                                    class="text-base text-gray-800 outline-none border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                                    value="Lucky"">
                                                    <option value="Pilih Gaji" selected>Pilih Gaji</option>
                                                    <option value="net">net</option>
                                                    <option value="org">org</option>
                                                    <option value="io">io</option>
                                                </select>
                                          ...
                                          <div class="w-full lg:w-6/12 px-4">
                                              <div class="relative w-full mb-3">
                                                  ...
                                                  <select id="Pilih Pengalaman"
                                                      class="text-base text-gray-800 outline-none border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                                      value="Lucky"">
                                                      <option value="Pilih Pengalaman" selected>Pilih Pengalaman</option>
                                                      <option value="net">net</option>
                                                      <option value="org">org</option>
                                                      <option value="io">io</option>
                                                  </select>
